...
#  Get the date from the file 
    ...
    print todayDate
#
#  This is run at 4 pm, but the target hour is say 8 pm so get the 1 value since trying for around 8 pm
    pmT = tree.xpath("//temperature[@type='hourly']/value/text()")[1]
    print pmT
...
#  Wind Speed 
    ...
    pmWndSpd = tree.xpath("//wind-speed/value/text()")[1]
...
#  Wind Direction 
    ...
    pmWndDir = tree.xpath("//direction/value/text()")[1]
    print pmWndDir
...
#  put the tweet together
    tweetext = 'Pub ride tonight: '+pmT+'F, wind '+pmWndSpd+' from '+pmWndDirT+', chance of rain '+pmPofP+'%' 
#
