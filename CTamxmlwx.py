...
#  This is run in the morning, get Morning Afternoon Temperatures
    pmT = tree.xpath("//temperature[@type='hourly']/value/text()")[5]
    print pmT
...
#  Wind Speed 
    ...
    pmWndSpd = tree.xpath("//wind-speed/value/text()")[5]
    print pmWndSpd+' knots'
    pmWndSpd = str(int(float(pmWndSpd)*1.15))
    print pmWndSpd+' mph'
    amWndSpd = tree.xpath("//wind-speed/value/text()")[2]
...
#  Wind Direction 
    ...
    pmWndDir = tree.xpath("//direction/value/text()")[5]
    print pmWndDir
    amWndDir = tree.xpath("//direction/value/text()")[2]
    print amWndDir
#
...
#
    if _platform == "linux" or _platform == "linux2":
        f = open('/home/dougdroplet2/projects/BikeWxX/BikeWxX/data/'+station_id[x]+'amforecast.txt','w')
        f.write(tweetext)
